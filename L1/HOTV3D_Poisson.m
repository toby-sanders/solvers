function [U, out] = HOTV3D_Poisson(A,b,n,opts)
...
% this "poisson" code just works for deconvolution and solves the U update
...
while numel(out.rel_chg_inn) < opts.iter
    ...
    for jj = 1:opts.inner_iter
        ...
        [U,params] = updateU_HOTV_Poisson(A,b,Dt,U,Uc,W,gL,mu,beta,params,opts);
        Uc = D(U);
