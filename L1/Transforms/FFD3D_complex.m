...
D = @(U)D_Forward(U,k,VX,VY,VZ,theta);
Dt = @(Uc)D_Adjoint(Uc,k,VX,VY,VZ,p,q,r,theta);


% high order finite differences
function [Uc] = D_Forward(U,k,VX,VY,VZ,theta)
...
% transpose FD
function dtxy = D_Adjoint(Uc,k,VX,VY,VZ,a,b,c,theta)
