function [D,Dt] = FD3D_pair_complex(ks,p,q,r,lambdas,theta)
...
D = @(U)ForwardD(U,ks,p,q,r,lambdas,theta);
Dt = @(dU)Dive(dU,ks,p,q,r,lambdas,theta);


% high order finite differences
function [dU] = ForwardD(U,ks,p,q,r,lambdas,theta)
...
%transpose FD
function dtxy = Dive(dU,ks,p,q,r,lambdas,theta)
dtxy = 0;
c = 0;
