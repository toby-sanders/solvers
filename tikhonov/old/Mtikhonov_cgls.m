function [X,out] = Mtikhonov_cgls(A,b,dim1,dim2,dim3,opts)
...
% number of levels used in the multiscale approach
...
[D,Dt] = FD3D_multiscale(opts.order,opts.levels,dim1,dim2,dim3);


%build the operator [A;D] and [A^t , Dt]
A = @(u,mode)tikhonov_operator_local(Amain,D,Dt,dim1,dim2,dim3,datadim,u,mode,opts.lambda,opts.levels);





function y = tikhonov_operator_local(A,D,Dt,dim1,dim2,dim3,datadim,u,mode,lambda,levels)
