...
%   if m-trHiAA>0, sigma2 = real(r'*r/(m - trHiAA));
%   else, sigma2 = sigma2; out.asserf = out.asserf + 1; end
%   if n-k-theta*trHiV>0, eta2 = real(u'*Vu/(n - k - theta*trHiV));
%   else, eta2 = eta2; out.asserf = out.asserf + 1; end
  theta = sigma2/eta2;
